...
<h1 class="text-bold"><i class="fas fa-money-bill-wave"></i> Contas a Pagar</h1>
@stop
...
<div class="card">
   <div class="card-header">
      <div class="card-tools">
         <a href="{{ route('financeiro.transacoes.create', ['kind' => 'conta_pagar']) }}" class="btn btn-sm btn-danger">
            <i class="fas fa-fw fa-plus"></i> Nova Conta a Pagar
         </a>
         <a href="{{ route('financeiro.caixa.index') }}" class="btn btn-sm btn-info">
            <i class="fas fa-fw fa-cash-register"></i> Caixa
         </a>
         <a href="{{ route('financeiro.categorias.index', ['type' => 'despesa']) }}" class="btn btn-sm btn-secondary">
   ...
   <div class="card-body">
      <!-- Filtros -->
      <form method="GET" action="{{ route('financeiro.contas-pagar.index') }}" class="mb-3">
         <div class="row">
            <div class="col-md-4">
         ...
         <table class="table table-hover text-nowrap">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td class="text-danger font-weight-bold">R$ {{ number_format($transaction->amount - $transaction->discount + $transaction->addition, 2, ',', '.') }}</td>
                  <td>
